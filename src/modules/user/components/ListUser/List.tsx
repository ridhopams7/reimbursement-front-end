...
class List extends Component<any, any> {
    handleOpenView = (userId: string) => {
        try {
            this.props.history.push(`/user/users/${userId}`);
        } catch (e) {
                    ...
                    <Table hover responsive size="sm" style={{ backgroundColor: "white" }} >
                        <thead>
                            <tr >
                                ...
                                <th className="th-center-middle-pointer"
                                    onClick={() => this.props.onChangeOrderBy("userName")}>User Name&nbsp;&nbsp;
                                    {request.orderBy === "userName" ? iconDirection : ""}</th>
                                <th className="th-center-middle-pointer"
                                    onClick={() => this.props.onChangeOrderBy("fullName")}>Full Name&nbsp;&nbsp;
                                    {request.orderBy === "fullName" ? iconDirection : ""}</th>
                                <th className="th-center-middle-pointer"
                                    onClick={() => this.props.onChangeOrderBy("email")}>Email&nbsp;&nbsp;
                                    {request.orderBy === "email" ? iconDirection : ""}</th>
                                <th className="th-center-middle-pointer"
                        ...
                        <tbody>
                            {itemslist && itemslist.content && itemslist.content.length ?
                                itemslist.content.map((userData: any, key: number) =>
                                    <tr className="tableodd" key={key}
                                        ...
                                        <td className="list-table text-align-center">{userData.userName}</td>
                                        <td className="list-table text-align-center">{userData.fullName}</td>
                                        <td className="list-table text-align-center">{userData.email}</td>
                                        <td className="list-table text-align-center">{userData.createdBy}</td>
                                        <td className="list-table text-align-center">{userData.createdDate ? Moment(userData.createdDate).format("DD-MMM-YYYY") : ""}</td>
                                        <td className="list-table text-align-center">
                                        <Button
                                            type="button"
                                            color="primary"
                                            className="button-action-list"
                                            onClick={() => this.handleOpenView(userData.id)}
                                            >
                                        ...
                                        <Button
                                            ...
                                            color="danger"
                                            className="button-action-list"
                                            onClick={() => this.confirmRemove(userData.id)}
                                            >
