...
export const accounts = (headers: any) => new Promise(async (resolve, reject) => {
  try {
    ...
    const listAccount = [{ id: "", code: "", codeName: "Account" }, ...res.data.account];
    resolve(listAccount);
  } catch (e) {
...
export const accountingPeriodsByStateActive = (headers: any) => new Promise(async (resolve, reject) => {
  try {
    const res = await HttpService.get(`accounting-periods/stateactive`, null, headers);
    const listAccountingPeriod = [...res.data.accountingPeriod];
...
export const currencies = (headers: any) => new Promise(async (resolve, reject) => {
  try {
